...
definition::ID resolver::Symbol::resolve_id_sym(scope::ID ctx, ast::ID nodeid, const std::string& id,
...
definition::ID resolver::Symbol::resolve_path_sym(module::ID ctx, ast::ID nodeid, const std::string& id,
...
{
  for (const auto* elem : CU.types->entries) {
...
void resolver::Symbol::resolve_Literal_Table(ast::Literal_Table& n)
{
