...
ast::ID parser::Parser_Declaration_Extension::extend_fn(type::ID extended_type)
{
  ...
  p.enter_scope(n.nodeid(), std::format("extend {} fn {}", type::dump(extended_type), n.name));
...
ast::ID parser::Parser_Declaration_Extension::extend_cast(type::ID extended_type)
{
  ...
  (void)p.add_definition(n.nodeid());
  p.enter_scope(n.nodeid(), std::format("extend {} as {}", dump(extended_type), dump(n.as_type)));
...
ast::ID parser::Parser_Declaration_Extension::extend_op_bin(type::ID extended_type)
{
  ...
  (void)p.add_definition(n.nodeid());
  p.enter_scope(n.nodeid(), std::format("extend {} op {}", dump(extended_type), ast::EOp_Bin_to_str(n.bin_op)));
...
ast::ID parser::Parser_Declaration_Extension::extend_op_un(type::ID extended_type)
{
  ...
  (void)p.add_definition(n.nodeid());
  p.enter_scope(n.nodeid(), std::format("extend {} op {}", dump(extended_type), ast::EOp_Unary_to_str(n.unary_op)));
...
ast::ID parser::Parser_Declaration_Extension::extend_op_subscript(type::ID extended_type)
{
  ...
  p.enter_scope(n.nodeid(),
                std::format("extend {} op {}", dump(extended_type), ast::EOp_Subscript_to_str(n.subscript_op)));
...
ast::ID parser::Parser_Declaration_Extension::extend_op_transfert(type::ID extended_type)
{
  ...
  (void)p.add_definition(n.nodeid());
  p.enter_scope(n.nodeid(),
                std::format("extend {} op {}", dump(extended_type), ast::ETransfertType_to_str(n.transfert_op)));
...
ast::ID parser::Parser_Declaration_Extension::extend_op_other(type::ID extended_type)
{
  ...
  (void)p.add_definition(n.nodeid());
  p.enter_scope(n.nodeid(), std::format("extend {} op {}", dump(extended_type), EOp_Other_to_str(n.other_op)));
