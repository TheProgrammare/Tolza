#include "metacode/definition.hpp"
...
bool metacode::Word::have_key(const MetaKey& key) const noexcept
{
...
metacode::EPatternKey metacode::str_to_EPatternKey(const MetaKey& key) noexcept
{
...
bool metacode::Instruction::match_pattern(const MetaPattern& pattern) const noexcept
{
