...
| decimal (fixed-point) | `d` `dT` `d32`-`d128` | `200.45d` `10d32` | 32-128 bits, rule format : N.N for N = T_size / 2 |
| unsigned decimal | `udT` `ud32`-`ud128` | `200.45ud` `10ud32` | 32-128 bits, .N for N = T_size / 2 |
| no type | `u0` |  | 
