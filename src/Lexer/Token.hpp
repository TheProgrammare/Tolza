...
const std::map<std::string, ETokenType> kKeywords = {
    ...
    // pointers
    {"ptr", ETokenType::PTR},
    {"std::shared_ptr", ETokenType::SPTR},
    {"std::unique_ptr", ETokenType::UPTR},
    {"std::weak_ptr", ETokenType::WPTR},
    ...
    {">=", ETokenType::OP_GREATER_EQUAL},
    {"<=", ETokenType::OP_LOWER_EQUAL},
    {"+", ETokenType::OP_PLUS},
    {"-", ETokenType::OP_MINUS},
    ...
    {"++", ETokenType::OP_INCREMENT},
    {"--", ETokenType::OP_DECREMENT},
    {"+-", ETokenType::SIGNATOR},
    // statement keys
    {"if", ETokenType::IF},
...
const std::initializer_list<ETokenType> kComparatorTokens = {
    ETokenType::OPEN_BRACKETS,  ETokenType::CLOSE_BRACKETS,    ETokenType::OP_EQUAL,
    ETokenType::OP_NOT_EQUAL,   ETokenType::OP_EQUAL_STRICTLY, ETokenType::OP_NOT_EQUAL_STRICTLY,
    ETokenType::OP_LOWER_EQUAL, ETokenType::OP_GREATER_EQUAL};
...
const std::initializer_list<ETokenType> kNumericTypeTokens = {
    ...
    ETokenType::T_F64,  ETokenType::T_F128,  ETokenType::T_FSIZE,
};
...
const std::initializer_list<ETokenType> kTypeTokens = {
    ...
    ETokenType::IDENTIFIER, ETokenType::TYPE};
const std::initializer_list<ETokenType> kHybridKeyNamespace = {
    ...
    ETokenType::WPTR,       ETokenType::ENTITY,     ETokenType::COMPONENT, ETokenType::GENERIC,
};
...
const std::initializer_list<ETokenType> kGenArgsValidTokens = {
    ...
    ETokenType::TYPE,          ETokenType::COMMA,          ETokenType::LET,
};
...
const std::initializer_list<ETokenType> boolOpHandled = {
    ETokenType::AND,   ETokenType::OR,           ETokenType::NOR,    ETokenType::XOR,      ETokenType::XNOR,
    ETokenType::NAND,  ETokenType::OP_NOT_EQUAL, ETokenType::B_AND,  ETokenType::B_OR,     ETokenType::B_NOR,
    ETokenType::B_XOR, ETokenType::B_XNOR,       ETokenType::B_NAND, ETokenType::OP_EQUAL, ETokenType::ASSIGN,
...
const std::initializer_list<ETokenType> integerOpHandled = {
    ...
    ETokenType::ASSIGN_REMAIN,  ETokenType::OPEN_BRACKETS, ETokenType::CLOSE_BRACKETS, ETokenType::OP_GREATER_EQUAL,
    ETokenType::OP_LOWER_EQUAL, ETokenType::OP_EQUAL,      ETokenType::OP_NOT_EQUAL,
};
const std::initializer_list<ETokenType> floatingOpHandled = {
    ...
    ETokenType::ASSIGN_POWER,
    ETokenType::ASSIGN_DIVIDE,
    ETokenType::ASSIGN_MODULO,
    ETokenType::ASSIGN_QUOTIEN,
    ETokenType::ASSIGN_REMAIN,
    ETokenType::OPEN_BRACKETS,
    ETokenType::CLOSE_BRACKETS,
    ETokenType::OP_GREATER_EQUAL,
    ETokenType::OP_LOWER_EQUAL,
...
const std::initializer_list<ETokenType> charOpHandled = {
    ETokenType::ASSIGN,           ETokenType::OPEN_BRACKETS,     ETokenType::CLOSE_BRACKETS,
    ETokenType::OP_GREATER_EQUAL, ETokenType::OP_LOWER_EQUAL,    ETokenType::OP_EQUAL,
    ETokenType::OP_NOT_EQUAL,     ETokenType::OP_EQUAL_STRICTLY, ETokenType::OP_NOT_EQUAL_STRICTLY,
};
...
const std::initializer_list<ETokenType> enumOpHandled = {
    ETokenType::ASSIGN,         ETokenType::OPEN_BRACKETS, ETokenType::CLOSE_BRACKETS, ETokenType::OP_GREATER_EQUAL,
    ETokenType::OP_LOWER_EQUAL, ETokenType::OP_EQUAL,      ETokenType::OP_NOT_EQUAL,
};
