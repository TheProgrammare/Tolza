...
namespace PAR {
	...
	struct Parser_Declaration_COP {
        ...
        void                                                                parse_entity_declaration(std::shared_ptr<AST::Declaration::COP::Entity> inEntity);
        [[nodiscard]] std::shared_ptr<AST::Declaration::COP::Entity_Op>         _entity_op(std::shared_ptr<AST::Declaration::COP::Entity> inEntity);
        [[nodiscard]] std::shared_ptr<AST::Declaration::COP::Entity_Cast>       _entity_cast(std::shared_ptr<AST::Declaration::COP::Entity> inEntity);
