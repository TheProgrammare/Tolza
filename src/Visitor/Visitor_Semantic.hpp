...
struct VisitorSem : VisitorDefault {
	...
	//void visit(AST::CodeBlock& n) override;
	...
	void visit(AST::Lit_Table& n) override;
	void visit(AST::Table_Population& n) override;
	...
	//void visit(AST::State_Loop& n) override;
	...
	//void visit(AST::GenOp& n) override;
