...
struct Visitor_Base {
	...
	// ============ MEMORY ============
	virtual void visit(AST::Memory::Move &n) = 0;
	virtual void visit(AST::Memory::New &n) = 0;
	virtual void visit(AST::Memory::Del &n) = 0;
	virtual void visit(AST::Memory::Val_Of_Ptr &n) = 0;
	virtual void visit(AST::Memory::Addr_Of_Ref &n) = 0;
	virtual void visit(AST::Memory::Dist &n) = 0;
	virtual void visit(AST::Memory::Size &n) = 0;
