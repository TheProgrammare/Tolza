...
void Visitor_Default::visit(AST::Declaration::Local::Capability &n) { n.reference->accept(*this); }
...
void Visitor_Default::visit(AST::Reference::Call_Argument &n) { n.val->accept(*this); }
void Visitor_Default::visit(AST::Reference::Call_System &n) { n.target_entity->accept(*this); }
void Visitor_Default::visit(AST::Reference::Call_Pipe &n)
{
  ...
  for (auto &elem : n.gen_args) {
    for (auto &elem2 : elem) elem2->accept(*this);
  }
...
void Visitor_Default::visit(AST::Reference::Table_Access &n) { n.selector->accept(*this); }
...
// ============ MEMORY ============
void Visitor_Default::visit(AST::Memory::Move &n) { n.target->accept(*this); }
...
void Visitor_Default::visit(AST::Memory::Val_Of_Ptr &n) { n.target->accept(*this); }
void Visitor_Default::visit(AST::Memory::Addr_Of_Ref &n) { n.target->accept(*this); }
void Visitor_Default::visit(AST::Memory::Dist &n)
{
  n.left->accept(*this);
  n.right->accept(*this);
}
void Visitor_Default::visit(AST::Memory::Size &n) { n.target->accept(*this); }
