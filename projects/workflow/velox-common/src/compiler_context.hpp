...
inline const std::set<Key_Arg_Asso> kas = {
    ...
    Key_Arg_Asso{.config_key = "target.reloc_model",   .config_val = "static",            .arg = "--reloc-model=static"   },
    Key_Arg_Asso{.config_key = "target.reloc_model",   .config_val = "pic",               .arg = "--reloc-model=pic"      },
    Key_Arg_Asso{.config_key = "target.reloc_model",   .config_val = "pie",               .arg = "--reloc-model=pie"      },
    Key_Arg_Asso{.config_key = "target.reloc_model",   .config_val = "ropi",              .arg = "--reloc-model=ropi"     },
    Key_Arg_Asso{.config_key = "target.reloc_model",   .config_val = "rwpi",              .arg = "--reloc-model=rwpi"     },
    Key_Arg_Asso{.config_key = "target.reloc_model",   .config_val = "ropi_rwpi",         .arg = "--reloc-model=ropi_rwpi"},
