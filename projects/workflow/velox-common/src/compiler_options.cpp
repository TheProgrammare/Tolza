...
size_t common::Compiler_Options::get_arch_size() const
{
  // on target_arch
...
std::string common::Compiler_Options::get_dir_project() const
{
  return common::resolve_path(dir_project, fs::path(current_config_file).parent_path().string());
}
std::string common::Compiler_Options::get_dir_build() const
{
  return common::resolve_path(dir_build, get_dir_project());
}
std::string common::Compiler_Options::get_dir_source() const
{
  return common::resolve_path(dir_source, get_dir_project());
}
std::string common::Compiler_Options::get_dir_vendor() const
{
  return common::resolve_path(dir_vendor, get_dir_project());
}
std::string common::Compiler_Options::get_dir_binding() const
{
  return common::resolve_path(dir_binding, get_dir_project());
}
std::string common::Compiler_Options::get_dir_ffi_json() const
{
  return common::resolve_path(dir_ffi_json, get_dir_project());
}
std::string common::Compiler_Options::get_dir_compiler() const
{
  return common::resolve_path(dir_compiler, get_dir_project());
}
std::string common::Compiler_Options::get_dir_stdlib() const
{
  return common::resolve_path(dir_stdlib, get_dir_project());
}
std::string common::Compiler_Options::get_dir_packages() const
{
  return common::resolve_path(dir_packages, get_dir_project());
}

const std::string& common::Compiler_Options::get_preprocess_dir() const
{
  static auto out = (fs::path(dir_build) / "preprocess").string();
  return out;
}

const std::string& common::Compiler_Options::get_debug_graph_dir() const
{
  static auto out = (fs::path(dir_build) / "graph").string();
  return out;
}

const std::string& common::Compiler_Options::get_llvmir_dir() const
{
  static auto out = (fs::path(dir_build) / "llvm-ir").string();
  return out;
}

std::string common::Compiler_Options::get_project_name() const
{
  if (target_project_name.empty()) return fs::path(dir_project).stem().string();
  return target_project_name;
}

const std::string& common::Compiler_Options::get_out_name() const
{
  static auto out = fs::path(current_config_file).stem().string();
  return out;
}

const std::string& common::Compiler_Options::get_config_file() const
{
...
std::string common::Compiler_Options::get_target_triple() const
{
...
void common::Compiler_Options::generate_preprocessor_args()
{
...
std::vector<std::string> common::Compiler_Options::to_args() const
{
...
common::Compiler_Options common::Sub_Compiler_Options::merge_context(const Compiler_Options& base_ctx) const
{
...
std::string common::Compiler_Options::ERelocModel_to_str(ERelocModel reloc)
{
  switch (reloc) {
...
std::string common::Compiler_Options::ECodeModel_to_str(ECodeModel code)
{
  switch (code) {
...
std::string common::Compiler_Options::EOptimization_to_str(EOptimization opt)
{
  switch (opt) {
...
std::string common::Compiler_Options::EWarnLevel_to_str(EWarnLevel wlevel)
{
  switch (wlevel) {
...
std::string common::Compiler_Options::EEmit_to_str(EEmit emit)
{
  switch (emit) {
...
common::Compiler_Options::EEmit common::Compiler_Options::str_to_EEmit(const std::string& s)
{
