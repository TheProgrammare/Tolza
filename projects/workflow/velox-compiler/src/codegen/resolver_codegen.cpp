...
size_t resolver::Codegen::start_resolver()
{
}
...
// ============ DECLARATION ============
llvm::Value* resolver::Codegen::visit(ast::declaration::Global_Variable& n)
{
  if (n.llvm_value) return n.llvm_value;
...
// ============ FUNCTION ============
llvm::Function* resolver::Codegen::visit(ast::declaration::Function& n)
{
...
llvm::Type* resolver::Codegen::visit(ast::declaration::Enum_Element& n)
{
  if (n.llvm_type) return n.llvm_type;
...
llvm::Type* resolver::Codegen::visit(ast::declaration::Flag& n)
{
  if (n.llvm_type) return n.llvm_type;
...
llvm::Type* resolver::Codegen::visit(ast::declaration::Union& n)
{
  if (n.llvm_type) return n.llvm_type;
...
void resolver::Codegen::visit(ast::declaration::Module_Alias& n)
{
}
llvm::Type* resolver::Codegen::visit(ast::declaration::Type_Alias& n)
{
...
llvm::Type* resolver::Codegen::visit(ast::declaration::Global_Generic& n)
{
}
...
llvm::Function* resolver::Codegen::visit(Local_Lambda& n)
{
  return nullptr;
}
void resolver::Codegen::visit(Local_Lambda_Capture& n)
{
}
void resolver::Codegen::visit(Local_Capture_Member& n)
{
}

llvm::Value* resolver::Codegen::visit(Local_Parameter& n)
{
  return n.llvm_arg;
}
void resolver::Codegen::visit(Local_Generic_Parameter_Element& n)
{
}
void resolver::Codegen::visit(Local_Generic_Parameters& n)
{
}

llvm::Value* resolver::Codegen::visit(Local_Pattern& n)
{
}
llvm::Value* resolver::Codegen::visit(Local_Pattern_Enum& n)
{
}
...
llvm::Value* resolver::Codegen::visit(Local_Variable_Binding& n)
{
  if (n.llvm_value) return n.llvm_value;
...
void resolver::Codegen::visit(Local_Tuple_Destructuring& n)
{
}
llvm::Value* resolver::Codegen::visit(Local_Variable& n)
{
  if (n.llvm_value) return n.llvm_value;
...
llvm::Value* resolver::Codegen::visit(Local_Capability& n)
{
  if (n.llvm_value) return n.llvm_value;
...
// ============ GENERIC ============
llvm::Value* resolver::Codegen::visit(ast::generic::Is_Type& n)
{
  return nullptr;
}
llvm::Value* resolver::Codegen::visit(ast::generic::Can_Cast& n)
{
  return nullptr;
}
llvm::Value* resolver::Codegen::visit(ast::generic::Have_Op& n)
{
  return nullptr;
}
...
// ============ LITERAL ============
llvm::Value* resolver::Codegen::visit(ast::literal::Boolean& n)
{
  if (n.llvm_value) return n.llvm_value;
...
llvm::Value* resolver::Codegen::visit(ast::literal::Integral& n)
{
  if (n.llvm_value) return n.llvm_value;
...
llvm::Value* resolver::Codegen::visit(ast::literal::Fixed_Point& n)
{
  if (n.llvm_value) return n.llvm_value;
...
llvm::Value* resolver::Codegen::visit(ast::literal::Floating_Point& n)
{
  if (n.llvm_value) return n.llvm_value;
...
llvm::Value* resolver::Codegen::visit(ast::literal::CUNE& n)
{
  if (n.llvm_value) return n.llvm_value;

  return n.llvm_value = llvm::ConstantInt::get(i8Ty, n.val);
}
llvm::Value* resolver::Codegen::visit(ast::literal::RUNE& n)
{
  if (n.llvm_value) return n.llvm_value;
...
llvm::Value* resolver::Codegen::visit(ast::literal::Text_Pure& n)
{
  if (n.llvm_value) return n.llvm_value;
  ...
  if (n.text_type == EPrimitiveTypeKind::c_str) {
...
llvm::Value* resolver::Codegen::visit(ast::literal::Text_Interpolation& n)
{
  return nullptr;
}
llvm::Value* resolver::Codegen::visit(ast::literal::Textual_Format& n)
{
...
llvm::Value* resolver::Codegen::visit(ast::literal::Format_Specifier& n)
{
  return nullptr;
}

llvm::Value* resolver::Codegen::visit(ast::literal::Table& n)
{
  return nullptr;
}
llvm::Value* resolver::Codegen::visit(ast::literal::Table_Population& n)
{
  return nullptr;
}

llvm::Value* resolver::Codegen::visit(ast::literal::Map& n)
{
  return nullptr;
}
llvm::Value* resolver::Codegen::visit(ast::literal::Tuple& n)
{
  if (n.llvm_value) return n.llvm_value;
...
llvm::Value* resolver::Codegen::visit(ast::literal::Range& n)
{
  if (n.llvm_value) return n.llvm_value;
...
llvm::Value* resolver::Codegen::visit(ast::literal::Iterator& n)
{
  if (n.llvm_value) return n.llvm_value;
  return nullptr;
}

llvm::Value* resolver::Codegen::visit(ast::literal::Enum& n)
{
  if (n.llvm_value) return n.llvm_value;
...
llvm::Value* resolver::Codegen::visit(ast::literal::Structured_Data& n)
{
  if (n.llvm_value) return n.llvm_value;
...
// ============ Expression ============
llvm::Value* resolver::Codegen::visit(ast::expression::If_Ternary& n)
{
  return nullptr;
}
llvm::Value* resolver::Codegen::visit(ast::expression::Member_Access& n)
{
  return nullptr;
}

llvm::Value* resolver::Codegen::visit(ast::expression::Self& n)
{
  return nullptr;
}
llvm::Value* resolver::Codegen::visit(ast::expression::Other& n)
{
  return nullptr;
}

llvm::Value* resolver::Codegen::visit(ast::expression::Call& n)
{
  if (n.llvm_value) return n.llvm_value;
...
llvm::Value* resolver::Codegen::visit(ast::expression::Call_Argument& n)
{
  if (n.llvm_value) return n.llvm_value;
  ...
  case EPassMode::Copy: return n.llvm_value = ensure_rvalue(*n.expression, "arg." + n.fn_param_type->declaration_name);
  case EPassMode::Addr: {
...
llvm::Value* resolver::Codegen::visit(ast::expression::Call_Pipe& n)
{
  return nullptr;
}

llvm::Value* resolver::Codegen::visit(ast::expression::Table_Access& n)
{
  return nullptr;
}

llvm::Value* resolver::Codegen::visit(ast::expression::Ptr_At& n)
{
  return nullptr;
}
llvm::Value* resolver::Codegen::visit(ast::expression::Ptr_Offset& n)
{
  return nullptr;
}
llvm::Value* resolver::Codegen::visit(ast::expression::Ptr_Val& n)
{
  return nullptr;
}
llvm::Value* resolver::Codegen::visit(ast::expression::Mut_Of& n)
{
  if (n.llvm_value) return n.llvm_value;
...
llvm::Value* resolver::Codegen::visit(ast::expression::Ref_Of& n)
{
  if (n.llvm_value) return n.llvm_value;
...
llvm::Value* resolver::Codegen::visit(ast::expression::Addr_Of& n)
{
  return nullptr;
}
llvm::Value* resolver::Codegen::visit(ast::expression::Size_Of& n)
{
  return nullptr;
}
llvm::Value* resolver::Codegen::visit(ast::expression::GetBits& n)
{
  return nullptr;
}

llvm::Value* resolver::Codegen::visit(ast::expression::Move& n)
{
  return nullptr;
}
llvm::Value* resolver::Codegen::visit(ast::expression::New_Ptr& n)
{
  return nullptr;
}
...
// ============ IF STATEMENT ============
void resolver::Codegen::visit(ast::statement::If& n)
{
...
// ============ FOR LOOP ============
void resolver::Codegen::visit(ast::statement::For& n)
{
  auto function = builder.GetInsertBlock()->getParent();
...
// ============ LOOP ============
void resolver::Codegen::visit(ast::statement::Loop& n)
{
  auto function = builder.GetInsertBlock()->getParent();
...
// ============ WHILE LOOP ============
void resolver::Codegen::visit(ast::statement::While& n)
{
  auto function = builder.GetInsertBlock()->getParent();
...
// ============ GOTO / LABEL ============
void resolver::Codegen::visit(ast::statement::GoTo& n)
{
  builder.CreateBr(n.label_sym->llvm_bb);
}

llvm::Value* resolver::Codegen::visit(ast::statement::GoTo_Label& n)
{
  if (!n.llvm_bb) {
    auto function = builder.GetInsertBlock()->getParent();
...
llvm::ReturnInst* resolver::Codegen::visit(ast::statement::Return& n)
{
...
llvm::BranchInst* resolver::Codegen::visit(ast::statement::Break& n)
{
  return current_bb_break ? builder.CreateBr(current_bb_break) : nullptr;
}

llvm::BranchInst* resolver::Codegen::visit(ast::statement::Continue& n)
{
  return current_bb_continue ? builder.CreateBr(current_bb_continue) : nullptr;
}

void resolver::Codegen::visit(ast::statement::Match& n)
{
}
void resolver::Codegen::visit(ast::statement::Match_Case& n)
{
}

// ============ OPERATION ============
llvm::Value* resolver::Codegen::visit(ast::operation::Cast_As& n)
{
  if (n.llvm_value) return n.llvm_value;
...
llvm::Value* resolver::Codegen::visit(ast::operation::Is& n)
{
  return nullptr;
}
llvm::Value* resolver::Codegen::visit(ast::operation::In& n)
{
  return nullptr;
}
llvm::Value* resolver::Codegen::visit(ast::operation::Assignment& n)
{
  if (n.llvm_value) return n.llvm_value;
...
llvm::Value* resolver::Codegen::visit(ast::operation::Binary& n)
{
...
llvm::Value* resolver::Codegen::visit(ast::operation::Unary& n)
{
  ...
  case EUnaryOpType::_plus: {
    if (auto ptr = std::dynamic_pointer_cast<ast::type::Primitive>(op_ty)) {
      if (EPrimType_is_integral(ptr->type)) {
        ...
        if (ptr->type == EPrimitiveTypeKind::f16)
          f_ty_size = f16Ty;
        else if (ptr->type == EPrimitiveTypeKind::f32)
          f_ty_size = f32Ty;
        else if (ptr->type == EPrimitiveTypeKind::f64)
          f_ty_size = f64Ty;
        else if (ptr->type == EPrimitiveTypeKind::f80)
          f_ty_size = f80Ty;
        else if (ptr->type == EPrimitiveTypeKind::f128)
          f_ty_size = f128Ty;
        else if (ptr->type == EPrimitiveTypeKind::fSize)
          f_ty_size = fSizeTy;
...
llvm::Value* resolver::Codegen::visit(ast::operation::Interval& n)
{
  return nullptr;
}
llvm::Value* resolver::Codegen::visit(ast::operation::Ptr_Dist& n)
{
  return nullptr;
}

// ============ MEMORY ============
void resolver::Codegen::visit(ast::memory::Del& n)
{
}
