...
/*
void resolver::Semantic::visit(ast::declaration::Function& n)
{
...
void resolver::Semantic::visit(ast::operation::Binary& n)
{
...
void resolver::Semantic::visit(ast::operation::Cast_As& n)
{
}


void resolver::Semantic::visit(ast::expression::Call_Argument& n)
{
