...
void PAR::Parser_Declaration_COP::parse_entity_declaration(std::shared_ptr<AST::Declaration::COP::Entity> parent_entity)
{
  static const std::string hint =
...
PAR::Parser_Declaration_COP::_entity_op(std::shared_ptr<AST::Declaration::COP::Entity> parent_entity)
{
...
PAR::Parser_Declaration_COP::_entity_cast(std::shared_ptr<AST::Declaration::COP::Entity> parent_entity)
{
  static const std::string hint =
