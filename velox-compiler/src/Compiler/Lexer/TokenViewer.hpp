...
#include "Compiler/ErrorOutput.hpp"
#include "Globals.hpp"
#include "Token.hpp"
...
public:
  ...
  {
    auto error_diag =
        Error_Diagnostic<Code>(scr_info, peek(), {}, Config::EPhase::parser, EErrorSeverity::error, {}, msg, hint);
  ...
  {
    auto error_diag =
        Error_Diagnostic<Code>(scr_info, tok, {}, Config::EPhase::parser, EErrorSeverity::error, {}, msg, hint);
    errors.push_back(error_diag.print_error());
  ...
  Config::EPhase           phase = Config::EPhase::lexer;
