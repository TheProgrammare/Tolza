...
const std::initializer_list<ETokenType> kPrimitiveTypeTokens = {
    ETokenType::T_U0,      ETokenType::T_BOOL,    ETokenType::T_ASCII,    ETokenType::T_STRING, ETokenType::T_UTF32,
...
const std::initializer_list<ETokenType> kHybridKeyNamespace = {
    ...
    ETokenType::T_F128,     ETokenType::T_FSIZE,    ETokenType::T_BOOL,    ETokenType::T_UTF32, ETokenType::T_ASCII,
    ETokenType::T_DECIMAL,  ETokenType::T_UDECIMAL, ETokenType::T_STRING,  ETokenType::T_TEXT,  ETokenType::FUNCTION,
    ETokenType::IDENTIFIER, ETokenType::TYPE,       ETokenType::T_U0,      ETokenType::CAST,    ETokenType::FUNCTION,
...
const std::initializer_list<ETokenType> kIndentifiable = {
    ...
    ETokenType::T_F32, ETokenType::T_F64, ETokenType::T_F128, ETokenType::T_STRING, ETokenType::T_TEXT,
    ETokenType::T_DECIMAL, ETokenType::T_UDECIMAL, ETokenType::T_TEXT, ETokenType::T_PTRDIFF,
    // boolean
    // literals
