...
struct Export final : public Mod {
  ...
  std::string debug_str() const override { return "export"; }
  void        accept(Visitor_Base& v) override { v.visit(*this); }
...
struct Mod_Alias final : public ADeclaration {
  ...
  std::string debug_str() const override { return "declaration mod \"" + name + "\" = " + module->debug_str(); }
  ESymbolType get_symbol_type() const override { return ESymbolType::Alias; }
...
struct Type_Alias final : public ADeclaration {
  ...
  std::string debug_str() const override { return "declaration type \"" + name + "\" = " + type->debug_str(); }
  ESymbolType get_symbol_type() const override { return ESymbolType::Alias; }
