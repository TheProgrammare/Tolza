...
struct Expr_ID final : virtual AIdentifier {
  ...
  std::string get_supposed_import_name() const override { return ""; };
  bool        is_qualified_id() const override { return false; }
  ...
  fs::path    get_as_path() const override { return fs::path("name"); }
...
struct Expr_ID_Qualified final : virtual AIdentifier {
  ...
  std::string get_supposed_import_name() const override { return path.empty() ? "" : path[0]; };
  bool        is_qualified_id() const override { return true; }
  std::string get_base_name() const override { return name; }
...
struct Expr_ID_Generic final : public AIdentifier, AType {
  ...
  std::string get_supposed_import_name() const override { return name->get_supposed_import_name(); };
  bool        is_qualified_id() const override { return name->is_qualified_id(); }
  std::string get_base_name() const override { return name->get_base_name(); }
  std::string mangle_local_name() const override { return name->mangle_local_name(); }
  std::string mangle_qualified_name() const override { return name->mangle_qualified_name() + "_" + mangle_type(); }
  fs::path    get_as_path() const override { return name->get_as_path(); }
